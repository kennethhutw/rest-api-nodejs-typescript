...
export class CalculatorRouter{
    ...
    private createGetCalculationById(){
        ...
        this.router.get('/:id', async (req: Request<{id:string}, CalculatorResultDto>, res)=>{

           res.send(await this.calculatorController.getCalculationById(req.params.id))

        })
    }

    private createDeleteCalculation(){
        /**
         * @openapi
         * /calculator/{id}:
         *   delete:
         ...
         *         $ref: '#/components/responses/InternalServerError'
         */
        this.router.delete('/:id',async (req:Request<{id:string}>, res, next: NextFunction)=>{
    ...
    private createUpdateCalculation(){
         ...
         *         $ref: '#/components/responses/InternalServerError'
         */
        this.router.put('/:id', async (req:Request<{id:string}, CalculatorResultDto, CalculatorCommandDto>, res)=>{
            res.send(await this.calculatorController.updateCalculation(req.params.id, req.body));
    ...
    private createCreateCalculation(){
        ...
        this.router.post('/', async (req:Request<{}, CalculatorResultDto, CalculatorCommandDto>, res)=>{
           res.status(201).send(await this.calculatorController.createCalculation(req.body))
        })
    }
